...
Консольное приложение с поддержкой ботов для игры в морской бой с управлением через стандартные потоки ввода/вывод. Также дополнительно реализован графический интерфейс для удобства управления игрой, написанный при помощи библиотеки SMFL
